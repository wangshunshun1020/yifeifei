define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'carswxsys/nav/index' + location.search,
                    add_url: 'carswxsys/nav/add',
                    edit_url: 'carswxsys/nav/edit',
                    del_url: 'carswxsys/nav/del',
                    multi_url: 'carswxsys/nav/multi',
                    table: 'carswxsys_nav',
                }
            });
