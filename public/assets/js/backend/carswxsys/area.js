define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'carswxsys/area/index' + location.search,
                    add_url: 'carswxsys/area/add',
                    edit_url: 'carswxsys/area/edit',
                    del_url: 'carswxsys/area/del',
                    multi_url: 'carswxsys/area/multi',
                    import_url: 'carswxsys/area/import',
                    table: 'carswxsys_area',
                }
            });
