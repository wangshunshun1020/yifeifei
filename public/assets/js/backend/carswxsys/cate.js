define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'carswxsys/cate/index' + location.search,
                    add_url: 'carswxsys/cate/add',
                    edit_url: 'carswxsys/cate/edit',
                    del_url: 'carswxsys/cate/del',
                    multi_url: 'carswxsys/cate/multi',
                    table: 'carswxsys_cate',
                }
            });
