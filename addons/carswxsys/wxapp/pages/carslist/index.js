...
Page({
  ...
  ,
    ...
    toSelectNew:function(){
      var that = this;
     // that.data.scrollTop = 146;
      that.data.isNew = !that.data.isNew ;
      that.data.isPrice = true;
    ...
    SelectPriceItem:function(e){
      ...
      if(brandinfo)
      {
        var params = {btprice:btprice,isuid:that.data.isuid,brandid:brandinfo.brandid,sbrandid:brandinfo.sbrandid,provinceid:that.data.provinceid,cityid:that.data.cityid};

      }else{

        var params = {btprice:btprice,isuid:that.data.isuid,brandid:0,sbrandid:0,provinceid:that.data.provinceid,cityid:that.data.cityid};
      }
    ...
    _loadData:function(callback){
      ...
      city = '';
        home.getSysinit(city,(data) => {
          ...
          if(brandinfo)
          {
            var params = {btprice:btprice,isuid:that.data.isuid,brandid:brandinfo.brandid,sbrandid:brandinfo.sbrandid};
    
          }else{
    
            var params = {btprice:btprice,isuid:that.data.isuid,brandid:0};
          }
    ...
    initpage:function(){
      ...
      if(brandinfo)
      {
        var params = {btprice:btprice,isuid:that.data.isuid,brandid:brandinfo.brandid,sbrandid:brandinfo.sbrandid,page:that.data.page,provinceid:that.data.provinceid,cityid:that.data.cityid, newtitle:that.data.NewTitle };

      }else{

        var params = {btprice:btprice,isuid:that.data.isuid,brandid:0,page:that.data.page,provinceid:that.data.provinceid,cityid:that.data.cityid,newtitle:that.data.NewTitle};
      }
    ...
    toSelectBrand:function(){
      ...
      var that = this;
        ...
        wx.navigateTo({
          url: "/pages/selectbrand/index?id=2"
        })
