<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"D:\work\ershoucar\yifeifei\public/../application/admin\view\carswxsys\adv\edit.html";i:1706194600;s:69:"D:\work\ershoucar\yifeifei\application\admin\view\layout\default.html";i:1689043528;s:66:"D:\work\ershoucar\yifeifei\application\admin\view\common\meta.html";i:1689043528;s:68:"D:\work\ershoucar\yifeifei\application\admin\view\common\script.html";i:1689043528;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-sort" data-rule="required" class="form-control" value="<?php echo htmlentities($row['sort']); ?>" name="row[sort]" type="number">
        </div>
    </div>
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2" data-toggle="addresspicker"><?php echo __('advname'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-advname" data-rule="required" class="form-control" name="row[advname]" value="<?php echo htmlentities($row['advname']); ?>"  type="text">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="radio">
                <label for="row[enabled]-normal"><input  name="row[enabled]" type="radio" value="1" <?php echo $row['enabled']==1?'checked' :''; ?>> 启用</label>
                <label for="row[enabled]-hidden"><input  name="row[enabled]" type="radio" value="0" <?php echo $row['enabled']==0?'checked' :''; ?>> 禁用</label>
            </div>
        </div>
    </div>
