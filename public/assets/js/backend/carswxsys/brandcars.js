define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'carswxsys/brandcars/index' + location.search,
                    add_url: 'carswxsys/brandcars/add',
                    edit_url: 'carswxsys/brandcars/edit',
                    del_url: 'carswxsys/brandcars/del',
                    multi_url: 'carswxsys/brandcars/multi',
                    table: 'carswxsys_brandcars',
                }
            });
