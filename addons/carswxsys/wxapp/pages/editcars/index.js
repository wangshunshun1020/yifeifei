...
Page({
  ...
  getCarsDetail:function() {
    ...
    cars.getCarsDetail((data) => {
      ...
      that.data.carnumdate = data.carnumdate;
      that.data.per = data.per;

      that.data.cartypeindex = isHasElementOne(that.data.cartype, data.cartype);
      that.data.cartypename = data.cartype;

      that.data.rectname = data.provincename+'/'+data.cityname+'/'+data.areaname;

      that.data.brandname = data.brandname+'/'+data.sbrandname;


      that.data.carrateindex = isHasElementOne(that.data.carrate, data.carrate);
      that.data.carratename = data.carrate;

      that.data.carchangeindex = isHasElementOne(that.data.carchange, data.carchange);
      that.data.carchangename = data.carchange;

      that.data.carfuelindex = isHasElementOne(that.data.carfuel, data.carfuel);
      that.data.carfuelname = data.carfuel;

      that.data.carposindex = isHasElementOne(that.data.carpos, data.carpos);
      that.data.carposname = data.carpos;

      that.data.carcolorindex = isHasElementOne(that.data.carcolor, data.carcolor);
      that.data.carcolorname = data.carcolor;

      that.data.brandid = data.brandid;
      that.data.sbrandid = data.sbrandid;



      var imgs1 = [];
     imgs1.push(data.thumb);

     that.data.imgs1  = imgs1;


     that.data.logoimglist = imgs1;
     that.data.imagelist = data.piclist;
   
     that.data.imgs2  = data.piclist;

    
     that.setData({
          tel:data.tel,
         cartypeindex:that.data.cartypeindex,
         carrateindex:that.data.carrateindex,
         carchangeindex:that.data.carchangeindex,
         carfuelindex:that.data.carfuelindex,
         carposindex:that.data.carposindex,
         carcolorindex:that.data.carcolorindex,
         carnumdate:that.data.carnumdate,
         brandinfo: that.data.brandinfo,
         rectname:that.data.rectname,
  ...
  onShow: function () {
   ...
   if(wx.getStorageSync('brandinfo'))
   {
    ...
    that.data.brandname = brandinfo.name;
