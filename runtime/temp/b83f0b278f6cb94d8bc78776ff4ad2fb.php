<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"D:\work\ershoucar\yifeifei\public/../application/admin\view\carswxsys\news\edit.html";i:1706194600;s:69:"D:\work\ershoucar\yifeifei\application\admin\view\layout\default.html";i:1689043528;s:66:"D:\work\ershoucar\yifeifei\application\admin\view\common\meta.html";i:1689043528;s:68:"D:\work\ershoucar\yifeifei\application\admin\view\common\script.html";i:1689043528;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <select class="cate form-control" name="row[cateid]"   >
                ...
                <option value="<?php echo $v['id']; ?>" <?php if($row['cateid'] == $v['id']): ?>selected<?php endif; ?> ><?php echo $v['name']; ?></option>
