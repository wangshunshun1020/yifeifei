define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'carswxsys/city/index' + location.search,
                    add_url: 'carswxsys/city/add',
                    edit_url: 'carswxsys/city/edit',
                    del_url: 'carswxsys/city/del',
                    multi_url: 'carswxsys/city/multi',
                    table: 'carswxsys_city',
                }
            });
