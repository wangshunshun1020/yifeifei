define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'carswxsys/brand/index' + location.search,
                    add_url: 'carswxsys/brand/add',
                    edit_url: 'carswxsys/brand/edit',
                    del_url: 'carswxsys/brand/del',
                    multi_url: 'carswxsys/brand/multi',
                    table: 'carswxsys_brand',
                }
            });
