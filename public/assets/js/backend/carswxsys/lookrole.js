define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'carswxsys/lookrole/index' + location.search,
                    add_url: 'carswxsys/lookrole/add',
                    edit_url: 'carswxsys/lookrole/edit',
                    del_url: 'carswxsys/lookrole/del',
                    multi_url: 'carswxsys/lookrole/multi',
                    table: 'carswxsys_lookrole',
                }
            });
