<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"D:\work\ershoucar\yifeifei\public/../application/admin\view\carswxsys\adv\add.html";i:1706194600;s:69:"D:\work\ershoucar\yifeifei\application\admin\view\layout\default.html";i:1689043528;s:66:"D:\work\ershoucar\yifeifei\application\admin\view\common\meta.html";i:1689043528;s:68:"D:\work\ershoucar\yifeifei\application\admin\view\common\script.html";i:1689043528;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2" ><?php echo __('advname'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-advname" data-rule="required" class="form-control" name="row[advname]" type="text">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="radio">
                <label for="row[enabled]-normal"><input  name="row[enabled]" type="radio" value="1" checked=""> 启用</label>
                <label for="row[enabled]-hidden"><input  name="row[enabled]" type="radio" value="0"> 禁用</label>
            </div>
        </div>
    </div>
