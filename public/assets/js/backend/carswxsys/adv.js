define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'carswxsys/adv/index' + location.search,
                    add_url: 'carswxsys/adv/add',
                    edit_url: 'carswxsys/adv/edit',
                    del_url: 'carswxsys/adv/del',
                    multi_url: 'carswxsys/adv/multi',
                    table: 'carswxsys_adv',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'advname', title: __('advname')},
