define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'carswxsys/news/index' + location.search,
                    add_url: 'carswxsys/news/add',
                    edit_url: 'carswxsys/news/edit',
                    del_url: 'carswxsys/news/del',
                    multi_url: 'carswxsys/news/multi',
                    table: 'carswxsys_news',
                }
            });
