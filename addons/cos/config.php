...
return [
    ...
    [
        ...
        'type' => 'string',
        'content' => [],
        'value' => 'AKID75qY3MTN5ZrwSs42wgCWefhZGm7GEzXr',
        'rule' => 'required',
        'msg' => '',
        'tip' => '请前往腾讯控制台 > 访问管理 > API密钥',
        'ok' => '',
    ...
    [
        ...
        'type' => 'string',
        'content' => [],
        'value' => 'EG7nGWbT7nIZcN2UjmeIjwwiIfuwnRt8',
        'rule' => 'required',
        'msg' => '',
        'tip' => '请前往腾讯控制台 > 访问管理 > API密钥',
        'ok' => '',
    ...
    [
        ...
        'type' => 'string',
        'content' => [],
        'value' => '7072-prod-5grglb5c0f403397-1369905838',
    ...
    [
        ...
        'type' => 'string',
        'content' => [],
        'value' => 'https://api.weixin.qq.com/_/cos/metaid/encode',
    ...
    [
        ...
        'type' => 'string',
        'content' => [],
        'value' => 'https://7072-prod-5grglb5c0f403397-1369905838.tcb.qcloud.la',
